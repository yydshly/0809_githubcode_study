...
| `REG-NORM-SHARP-CANONICAL-PNG@0.9.0` | 相同像素 / encoder 架构 + versioned gold identity | `CAP-02` | canonical PNG normalize / export | `scope-frozen/implementation-not-started` | 只冻结 `goldRecordId` 精确绑定、新 12-source / 36-attempt 分母与停止规则；definition / result 为 0，非 Gate B |
