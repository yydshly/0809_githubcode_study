...
| Image Product Studio R17 | 多 Skill 图片产品、单图/逐张/合集与产品适配的历史探索 | 产品研究、ImageGen、HTML/CSS、Canvas | 已归档 | [研究目录](projects/visual-route-studio) | 无单一上游；见[来源边界](projects/visual-route-studio/UPSTREAM.md) | [GitHub 源码目录](https://github.com/yydshly/0809_githubcode_study/tree/main/projects/visual-route-studio) | [GitHub Pages 逻辑演示](https://yydshly.github.io/0809_githubcode_study/visual-route-studio/compositor/) · [本地完整模式](projects/visual-route-studio/compositor) | 本地原创研究；许可证待定 |
| Single Image Studio | 本地优先的单图处理工作室：基础编辑、文档、压缩、隐私分享、场景套装与可选抠图 Provider | Node.js、Canvas、Image API | 可运行（公开技术体验 / 内部 Alpha） | [项目目录](projects/single-image-studio) | 无单一上游；见[来源边界](projects/single-image-studio/UPSTREAM.md) | [GitHub 源码目录](https://github.com/yydshly/0809_githubcode_study/tree/main/projects/single-image-studio) | [Vercel 公开技术体验](https://0809-githubcode-study.vercel.app/) · [本地运行说明](projects/single-image-studio/README.md#快速开始) | 本地原创研究；许可证待定 |
| ID Photo Workflow Lab | HivisionIDPhotos 的能力、展示、处理原理与本地 API 复用 Demo | Node.js、原生 Web、Hivision FastAPI | 研究中 | [研究与 Demo](projects/id-photo-workflow-lab) | [HivisionIDPhotos](https://github.com/Zeyi-Lin/HivisionIDPhotos) · [完整来源账本](projects/id-photo-workflow-lab/UPSTREAM.md) | [GitHub 源码目录](https://github.com/yydshly/0809_githubcode_study/tree/main/projects/id-photo-workflow-lab) | [GitHub Pages 静态效果 Demo](https://yydshly.github.io/0809_githubcode_study/id-photo-workflow-lab/) · [本地真实 Demo](projects/id-photo-workflow-lab/README.md#快速开始) | 本地原创代码/研究许可证待定；Hivision Apache-2.0，模型逐项见来源账本 |
