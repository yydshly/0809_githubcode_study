...
| 维度 | 当前状态 | 数量 / 等级 | 这代表什么 |
| --- | --- | --- | --- |
| 研究阶段 | Slice 07 唯一注册 Gate-B smoke 已闭合且未过门 | `Slice 07: closed-non-pass / Gate-B-denied / calibration-forbidden / non-C1 / non-product` | 36 / 36 terminal；18 applicable 全过，18 rejection 因 driver binding 缺陷全部 non-pass；不得重跑，须新版本 |
