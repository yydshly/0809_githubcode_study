...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Skill Zine Summary | Codex 照片/Zine 技能的技术谱系、渲染后端与验证方法 | Codex Skills、ImageGen、Python、HTML/CSS/SVG | 研究中 | [研究目录](projects/skill-zine-summary) | [tluy/skill-zine-summary](https://github.com/tluy/skill-zine-summary) | 暂无 | 暂无 | 汇总库未声明；子库见[来源审计](projects/skill-zine-summary/UPSTREAM.md) |
