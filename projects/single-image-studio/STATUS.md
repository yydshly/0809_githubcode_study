...
| 维度 | 当前状态 | 数量 / 等级 | 这代表什么 |
| --- | --- | --- | --- |
| 研究阶段 | Slice 08 唯一 registered invocation 已在首个 attempt worker 前 protocol-failed | `Slice 08: closed-protocol-failed / incomplete-result / Gate-B-no-decision / calibration-forbidden / non-C1 / non-product` | partial tree 2 files / 1 request / 1 started event / 0 terminal / 0 output；不得修复后重跑，下一步必须新版本 |
