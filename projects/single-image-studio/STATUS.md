...
| 维度 | 当前状态 | 数量 / 等级 | 这代表什么 |
| --- | --- | --- | --- |
| 研究阶段 | Slice 08 results-zero definition 已冻结，尚未运行 Gate B smoke | `Slice 08: definition-frozen / results-zero / Gate-B-smoke-not-run / calibration-forbidden / non-C1 / non-product` | `2026-08-15T13:37:23.038Z`；16 schemas / 23 records / 12 sources / 36 planned attempts / 0 results；须先提交推送定义，再运行唯一完整 smoke |
...
| Slice 08 定义 | results-zero canonical tree 已冻结；registered result 尚不存在 | 16 schemas / 23 records / 12 source wrappers / 36 planned attempts / 0 results；full tree `c6845e68…5cc24` | closed self-hashed context 绑定 disposition / code / source / manifest / gold；rejection worker-free；中央验证重开 lineage、ledger、PNG/oracle 与完整 fake 结果；详见 [Slice 08 definition evidence](research/SLICE_08_EVIDENCE.md) |
...
10. **Slice 08 results-zero definition 已冻结**：按 [Slice 08 范围合同](research/SLICE_08_CONTRACT.md) 新建 closed self-hashed `caseContext`，实际 callback 只接收 `{caseContext}`；source bytes / hash 与 gold 都需交叉绑定，rejection 不得读取 gold 或启动 worker。durable runner、registered driver、deterministic generator 与 central validator 已闭合，fake-only `28 / 28`。definition 于 `2026-08-15T13:37:23.038Z` 冻结为 16 schemas、23 records、12 wrappers、36 planned attempts、0 results，full-tree `c6845e689a33607f8c031e87eec8a42cbfdc78b3ca6ca2698e2b5cf98c35cc24`；详见 [Slice 08 definition evidence](research/SLICE_08_EVIDENCE.md)。必须先提交推送该定义，才可运行一次完整 normalize / export smoke；不能拼接 Slice 07 或只补跑 rejection，calibration 继续禁止。
