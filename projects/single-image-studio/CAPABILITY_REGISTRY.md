...
| `REG-NORM-SHARP-CANONICAL-PNG@0.10.0` | Slice 09 像素 / encoder lineage + 新 open-calibration protocol identity | `CAP-02` | canonical PNG normalize / export | `planned/protocol-and-definition-preview-fake-tested` | 计划 normalize/export 各 48 sources × 3，共 96/288；零 retry/replacement；协议 7/7、definition preview 9/9，双临时树 16 schemas / 96 wrappers / 48 gold identities / 4 manifests。durable runner、正式 definition、results 与 formal holdout 均 not-created；非 C1、非产品支持 |
