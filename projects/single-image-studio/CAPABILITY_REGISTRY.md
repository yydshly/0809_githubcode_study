...
| `REG-NORM-SHARP-CANONICAL-PNG@0.11.0` | Slice 10 immutable failure lineage + versioned expected projection / truthful lifecycle | `CAP-02` | canonical PNG normalize / export | `definition-frozen/results-zero/calibration-not-run` | 23 schemas、96 source wrappers / 288 attempts、48 gold identities、4 manifests、0 copied bytes/results；protocol、durable operation、registered driver与central validator通过42 / 42 fake-only tests；零 retry/replacement，非 C1、非产品支持 |
...
8. Slice 11 / `@0.11.0` results-zero definition 已冻结；projection、事实派生 lifecycle、frozen-material case executor、durable request / claim / publication / operation close、registered driver 与 central validator 已通过 42 / 42 fake-only tests。definition 含 23 schemas、96 个新 source wrapper、48 gold identities、4 manifests、0 copied image bytes / results；每 operation 固定48×3，发布形成288-event fsynced chain。definition commit推送且工作树clean前不得运行；同版本零retry/replacement，非C1、非产品支持。
