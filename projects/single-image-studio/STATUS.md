...
| 维度 | 当前状态 | 数量 / 等级 | 这代表什么 |
| --- | --- | --- | --- |
| 研究阶段 | Slice 10 results-zero definition 与 literal pins 已冻结 | `Slice 10: definition-frozen-results-zero / pins-verified / runtime-rechecked / calibration-not-run / non-C1 / non-product` | 183 files、22 schemas、96 sources、288 planned attempts、results=0；必须先提交推送本基线，之后才允许唯一 registered invocation |
...
| Slice 10 results-zero definition | freeze `2026-08-15T18:03:39.680Z`；index `1b0eca…bcbc` / `c2b7ae…b13c`；full tree `0250a7…d532` | normalize / export 各 48 sources × 3 = 144 attempts；合计 96 / 288 | central pins/runtime/regeneration 全通过；result 与 formal holdout 均未创建。详见 [Slice 10 合同](research/SLICE_10_CONTRACT.md) |
...
12. **Slice 10 results-zero definition 已冻结，尚未运行 calibration**：冻结 UTC `2026-08-15T18:03:39.680Z`，共 183 files / 22 schemas / 96 source wrappers / 48 gold identities / 4 manifests / 288 planned attempts / 0 results。index content/file 为 `1b0ecac1b1d8b2320fc95fd92f53bf4ebdae79e7879be910d0c232cfeb56bcbc` / `c2b7ae163a1cd68656e16d97b00cacd295182b80ed1ae9021d9dc28b414b13c3`，schema tree `ee7415e36739dea08b128c590741d40c9340a3e24cef72856a2912238923e24c`，full tree `0250a743487d681e4282909a21804e142901e536dfc8a8ebee31a17f66cdd532`。central 的 pins、fresh runtime 与 deterministic regeneration 均通过。必须先提交并推送该不可变基线，之后才允许唯一 registered invocation；当前 calibration、formal holdout、C1 与产品支持仍为 0。
