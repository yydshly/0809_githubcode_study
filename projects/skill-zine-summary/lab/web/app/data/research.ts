...
export const extraUpstreamDemos: Record<string, DemoImage[]> = {
  "dyy-photo-deconstruct": [
    { src: "/generated/upstream/dyy-photo-deconstruct/04.jpg", alt: "上游极简样例四", caption: "补充样例：观察不同题材如何缩减到相同的最小标记纪律。" },
    { src: "/generated/upstream/dyy-photo-deconstruct/05.jpg", alt: "上游极简样例五", caption: "补充样例：比较剪影与淡墨块承担的信息差异。" },
    { src: "/generated/upstream/dyy-photo-deconstruct/06.jpg", alt: "上游极简样例六", caption: "补充样例：检查大面积空纸是否仍能保持主体可读。" },
  ],
  "travel-photo-abstraction": [
    { src: "/generated/upstream/travel-photo-abstraction/04.png", alt: "上游 bloom veil 样例", caption: "补充样例：颜色角色和遮挡关系进入抽象面板。" },
    { src: "/generated/upstream/travel-photo-abstraction/05.png", alt: "上游 night castle 样例", caption: "补充样例：夜景输入仍维持照片锁定和面板分工。" },
    { src: "/generated/upstream/travel-photo-abstraction/06.png", alt: "上游 rocky coast 样例", caption: "补充样例：复杂海岸被转译为轴线、重量和负空间。" },
  ],
  "scenes-gathered-zine": [
    { src: "/generated/upstream/scenes-gathered-zine/source-02.jpg", alt: "上游冬季穿行输入", caption: "第二组输入：用于检查实景拼贴是否能迁移到冬季场景。" },
    { src: "/generated/upstream/scenes-gathered-zine/result-02.jpg", alt: "上游冬季穿行结果", caption: "第二组结果：真实照片继续作为锚点，抽象区回应穿行关系。" },
  ],
  "scene-distillation-zine": [
    { src: "/generated/upstream/scene-distillation-zine/source-02.jpg", alt: "上游雪落输入", caption: "第二组输入：低对比雪景提供不同的情绪命题。" },
    { src: "/generated/upstream/scene-distillation-zine/result-02.jpg", alt: "上游雪落蒸馏结果", caption: "第二组结果：不保留照片，以轻重和间隔重新形成场景。" },
  ],
  "gc-minimal-zine-poster": [
    { src: "/generated/upstream/gc-minimal-zine-poster/04.jpeg", alt: "上游 pause map 样例", caption: "补充样例：内容被编译为停顿、路径和单一色锚。" },
    { src: "/generated/upstream/gc-minimal-zine-poster/05.jpeg", alt: "上游 shore pause 样例", caption: "补充样例：同类海岸主题如何避免重复构图。" },
    { src: "/generated/upstream/gc-minimal-zine-poster/06.jpeg", alt: "上游 typhoon memory 样例", caption: "补充样例：强事件主题仍保持留白与微型文字。" },
  ],
  "photo-revival": [
    { src: "/generated/upstream/photo-revival/04.png", alt: "上游汽车重绘样例", caption: "补充样例：机械主体被转成轻量手绘记忆。" },
    { src: "/generated/upstream/photo-revival/05.png", alt: "上游相机重绘样例", caption: "补充样例：静物输入保留主体和少量记忆细节。" },
    { src: "/generated/upstream/photo-revival/06.png", alt: "上游火车窗重绘样例", caption: "补充样例：观察窗框、风景与纸面留白的关系。" },
  ],
  "photo-relic-editorial": [
    { src: "/generated/upstream/photo-relic-editorial/04.png", alt: "上游鸟巢倒影样例", caption: "补充样例：倒影被压缩为单一结构遗迹。" },
    { src: "/generated/upstream/photo-relic-editorial/05.png", alt: "上游中国尊样例", caption: "补充样例：高层建筑的竖向重量进入版画面板。" },
    { src: "/generated/upstream/photo-relic-editorial/06.png", alt: "上游角楼水面样例", caption: "补充样例：建筑与水面共同形成跨区节奏。" },
  ],
  "photo-distill": [
    { src: "/generated/upstream/photo-distill/03-poster.jpg", alt: "上游七姐妹代码海报", caption: "第二组结果：海岸关系由代码符号确定性表达。" },
    { src: "/generated/upstream/photo-distill/04-original.jpg", alt: "上游花朵原图", caption: "第三组输入：花朵数量、间隔和色彩成为关系量。" },
    { src: "/generated/upstream/photo-distill/05-poster.jpg", alt: "上游花朵代码海报", caption: "第三组结果：浏览器渲染并测量色锚与着墨率。" },
  ],
  "poetic-line-zine-poster": [
    { src: "/generated/upstream/poetic-line-zine-poster/04.png", alt: "上游河畔树木样例", caption: "补充样例：树木题材由 mass 和 rhythm 共同路由。" },
    { src: "/generated/upstream/poetic-line-zine-poster/05.png", alt: "上游 small arrival 样例", caption: "补充样例：小型主体与扫线保持明显比例差。" },
    { src: "/generated/upstream/poetic-line-zine-poster/06.png", alt: "上游黄鹤铁路样例", caption: "补充样例：交通路径与建筑重量进入同一面板。" },
  ],
  "photo-abstract-editorial": [
    { src: "/generated/upstream/photo-abstract-editorial/04.jpg", alt: "上游抽象编辑样例四", caption: "补充样例：检查另一组空间事实的形状映射。" },
    { src: "/generated/upstream/photo-abstract-editorial/05.jpg", alt: "上游抽象编辑样例五", caption: "补充样例：比较照片区和抽象面板的视觉重量。" },
    { src: "/generated/upstream/photo-abstract-editorial/06.jpg", alt: "上游抽象编辑样例六", caption: "补充样例：观察短标题是否仍保持克制。" },
  ],
  "photo-to-zine-postcard": [
    { src: "/generated/upstream/photo-to-zine-postcard/04.png", alt: "上游蓝弧湖明信片", caption: "补充样例：湖景如何迁移到固定双面产品系统。" },
    { src: "/generated/upstream/photo-to-zine-postcard/05.png", alt: "上游黄昏湖面明信片", caption: "补充样例：低光色板仍严格提取三枚来源色。" },
    { src: "/generated/upstream/photo-to-zine-postcard/06.png", alt: "上游青绿湖明信片", caption: "补充样例：系列变化集中在照片、主元素和色卡。" },
  ],
};
